...
exercises:
  ...
  - question: "Horas de estágio ou atividade complementar feitas antes do início da matrícula valem?"
    answer: "Não. Só contam horas a partir do início da graduação. Trabalho ou curso anterior ao primeiro dia de aula não é contabilizado."
  - question: "Onde o aluno abre solicitações de declaração, histórico, estágio e atividades complementares?"
    answer: "No sistema de requerimento (requerimento.infinit.edu.br). Cada solicitação gera um número de protocolo para acompanhamento no CRM da instituição."
  - question: "Por que atividades complementares são consideradas 'mais difíceis' de cumprir que estágio?"
    answer: "Estágio pode ser concentrado (400h em menos de 4 meses) ou substituído por trabalho na área. Atividades complementares têm muitas categorias com limite de horas cada e exigem comprovante de cada atividade (palestra, curso, hackathon, etc.), então é preciso acumular várias ações ao longo do curso."
  - question: "Curso pirateado ou sem certificado pode ser usado como atividade complementar?"
    answer: "Não. É obrigatório comprovante (certificado, crachá, declaração). Curso sem comprovação oficial não é aceito."
---
...
- Primeira aula do bloco de entrada; integra alunos de diferentes graduações.
- Pré-requisito: nenhum. Serve de base para entender prazos (estágio, atividades) e uso do requerimento ao longo do curso.
...
1. **Bloco = conjunto de 5 disciplinas em 6 meses com projeto no final** — Não há TCC; a integração de conhecimentos é feita pelo projeto de fim de bloco. Reconhecer isso evita expectativa errada de TCC.
2. **Avaliação por competência: só trabalhos, sem prova** — Trabalhos a cada duas semanas e TP (trabalho final). Não há prova de múltipla escolha nem nota de 0 a 10 no modelo descrito.
3. **Estágio 400h é obrigatório para concluir o curso** — Não é possível se formar sem cumprir as 400h; não pode ser feito após a conclusão das disciplinas.
4. **Termo substitutivo de estágio** — Quem já trabalha na área (CLT, PJ, servidor) pode comprovar com documentação e ter as 400h validadas sem novo contrato de estágio.
5. **Atividades complementares exigem comprovante e têm limite por categoria** — Tabela no manual da graduação; curso pirateado ou sem certificado não vale.
6. **Requerimento (requerimento.infinit.edu.br)** — Canal único para declaração de matrícula, histórico, trancamento, estágio, atividades complementares; gera número de solicitação para acompanhamento.
7. **Horas de estágio e de atividades complementares só contam a partir do início da graduação** — Nada anterior à matrícula é considerado.
...
- **Definição:** Horas a cumprir em atividades extras (palestras, cursos de idiomas, hackathon, trabalho voluntário, cursos online com certificado etc.), conforme tabela do manual da graduação, com comprovante para cada item.
- **Quando usar:** Ao participar de palestra, curso (Coursera, Udemy etc.), hackathon, congresso, trabalho voluntário — guardar comprovante (certificado, crachá, declaração) e lançar via requerimento como atividade complementar.
- **Quando NÃO usar:** Curso ou atividade sem comprovante (ex.: curso pirateado) não é aceito.
- **Erro comum:** Deixar para o final do curso; as horas são “picadinhas” e há limite por categoria, então é melhor ir acumulando desde o início.
- **Pegadinha:** Curso de idiomas em andamento pode contar a partir do início da graduação (horas do semestre), mas precisa comprovação da instituição.

#### Requerimento (requerimento.infinit.edu.br)

- **Definição:** Sistema em que o aluno abre solicitações (declaração de matrícula, histórico, trancamento, estágio, atividades complementares etc.); cada uma gera um número de solicitação para acompanhamento.
- **Quando usar:** Para qualquer pedido formal que a instituição liste (declaração, histórico, lançamento de estágio, atividades complementares, etc.).
- **Erro comum:** Não usar o requerimento e esperar resposta por outro canal; o andamento é rastreado pelo número do requerimento.

### 6. Procedimento / execução

- **Requerimento:** Acessar requerimento.infinit.edu.br → escolher tipo de solicitação → preencher e anexar documentos quando for o caso → anotar número da solicitação e acompanhar.
- **Termo substitutivo de estágio:** Ler manual da graduação (estágio) → reunir comprovantes (CLT/PJ/servidor) → abrir requerimento de estágio/substitutivo e anexar → aguardar análise do coordenador.
- **Atividade complementar:** Ver tabela no manual → participar da atividade → obter comprovante → abrir requerimento de lançamento de atividade complementar e anexar comprovante.
- **Erro típico:** Enviar documento sem passar pelo requerimento ou sem número de solicitação, dificultando o acompanhamento.
- **Evidência de acerto:** Número de solicitação recebido e, quando aplicável, horas de estágio ou atividades complementares contabilizadas no sistema.

### 7. Exemplos relevantes

- **PJ que presta serviço na área:** Comprovar com carta do contratante, nota fiscal e descrição de projeto/horas; coordenador pode aprovar como termo substitutivo.
- **Servidor público na área:** Carta da chefia atestando função e que atua na área de TI (ou equivalente à graduação) pode ser suficiente para análise do termo substitutivo.
- **Atividade complementar:** Participar de um hackathon → guardar crachá ou certificado de participação → enviar pelo requerimento na categoria correspondente da tabela do manual.
- **Curso Udemy/Coursera:** Completar o curso, obter certificado e enviar pelo requerimento com a carga horária; só vale a partir do início da graduação.
...
- Aula introdutória e institucional; não há prova escrita. O que pode ser cobrado em trabalhos ou reflexões: saber explicar o que é bloco, onde abrir requerimento, em que casos existe termo substitutivo de estágio e por que atividades complementares precisam de comprovante. Perguntas típicas: “Onde solicito declaração de matrícula?” (requerimento); “Trabalho CLT na área, preciso fazer estágio em outra empresa?” (não, se termo substitutivo for aprovado).

### 10. Pontos de atenção

- Não inventar estágio ou atividade complementar sem comprovação; documentação falsa pode gerar sanção.
