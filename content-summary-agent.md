...
**PRINCÍPIO CENTRAL:** ISS é construído para **escaneamento primeiro, leitura depois.** Se o material não for útil em escaneamento rápido, está errado. O usuário não lê tudo: escaneia, revisa rápido, volta depois. ISS precisa ser scan-first, detail-second — não complete-first.
...
**Filosofia aplicada:** ISS é infraestrutura de revisão, não aula. Prioridade máxima em eficiência cognitiva e capacidade de revisão rápida.  
...
**OBJETIVO:** Ser revisável em menos de 20 segundos. Máxima compressão sem perder informação crítica. **Aumenta significativamente o valor do material** ao fornecer uma lista condensada e verificável do que o aluno deve saber.
...
- Focado em revisão rápida e reconhecimento em provas
